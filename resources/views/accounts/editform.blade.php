{!! Form::open(['method' => 'put', 'action' => ['AccountController@update', ''], 'class' => 'form-horizontal edit-form hidden']) !!}
<fieldset class="has-warning">
    ...
    <div class="form-group @if($errors->first('name')) has-error @endif">
        ...
        <div class="col-lg-9">
            <input id="edit-name" class="form-control" placeholder="Ime" type="text" name="name" value="">
        </div>
    </div>
    <div class="form-group @if($errors->first('type')) has-error @endif">
        <label for="edit-type" class="col-lg-3 control-label">Tip</label>
        <div class="col-lg-9">
            {!! Form::select('type', ['cash' => 'Keš', 'bank' => 'Banka'], null, ['class' => "form-control", 'id' => "edit-type"]) !!}
        </div>
    </div>
