...
<head>
    ...
    <link href="{{ asset('style/datepicker/bootstrap-datepicker3.min.css') }}" rel="stylesheet">
        ...
        <div class="collapse navbar-collapse" id="app-navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                <ul class="nav navbar-nav">
                    <li><a href="{{ action('StatisticController@index') }}">Statistics</a></li>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Balance
                            <span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
